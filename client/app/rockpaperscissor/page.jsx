  ...
  return (
    <div className="App">
      ...
      <div className='choice'>
        ...
        <img className='user-hand' src={userChoice === 'rock' ? "/Images/rock.jpeg" : userChoice === 'paper' ? "/Images/paper.jpeg" : "/Images/scissor.jpeg"} alt='' />
        </div>
        <div className='choice-computer'>
        <img className='computer-hand' src={computerChoice === 'rock' ? "/Images/rock.jpeg" : computerChoice === 'paper' ? "/Images/paper.jpeg" : "/Images/scissor.jpeg"} alt='' />
        </div>
      </div>
